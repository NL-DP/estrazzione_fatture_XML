...
# "source": "testata" = valore preso dalla testata fattura (ripetuto su ogni riga articolo)
# "source": "linea"   = valore preso dalla riga articolo
FIELD_MAP_DETTAGLIO = [
    {"key": "fornitore",          "label": "Fornitore",    "width": 28, "format": "text",     "source": "testata"},
    {"key": "numero_fattura",     "label": "N. Fattura",   "width": 12, "format": "center",   "source": "testata"},
    {"key": "data",               "label": "Data",         "width": 12, "format": "date",     "source": "testata"},
    {"key": "modalita_pagamento", "label": "Mod. Pag.",    "width": 14, "format": "center",   "source": "testata"},
    {"key": "codice",             "label": "Codice",       "width": 10, "format": "center",   "source": "linea"},
    {"key": "descrizione",        "label": "Descrizione",  "width": 42, "format": "text",     "source": "linea"},
    {"key": "quantita",           "label": "Quantita",     "width": 10, "format": "number",   "source": "linea"},
    {"key": "udm",                "label": "UdM",          "width":  6, "format": "center",   "source": "linea"},
    {"key": "prezzo_unitario",    "label": "P. Unitario",  "width": 13, "format": "currency", "source": "linea"},
    {"key": "prezzo_totale",      "label": "Totale Riga",  "width": 13, "format": "currency", "source": "linea"},
    {"key": "aliquota_iva",       "label": "IVA %",        "width":  8, "format": "percent",  "source": "linea"},
]
